...
# MAGIC %md
# MAGIC ## Probabilistic Matching Customer : Utility Functions (Unit Testing)
# MAGIC ## Description:
# MAGIC This notebook is called from the UnitTestProbabilisticMatchingCustomer notebook to execute the customer matching rules.
# MAGIC ## Requirements:
...
s_coloumns_of_interest = ['s_rcis_id_cl','s_fa_id_cl','s_dq_first_name_cl','s_dq_last_name_cl','s_dq_e_mail_cl','s_dq_primary_phone_cl','s_dq_alternate_phone_1_cl','s_dq_alternate_phone_2_cl','s_mailing_address_no_zipcode_dq_cl','s_service_address_no_zipcode_dq_cl','s_account_type','unique_id','source_dataset']
...
# This Function as a part of Splink's requirement rename each coloumn/attribute of interest to make it similar in both data source.
r_coloumns_of_interest = ['r_rcis_id_cl','r_fa_id_cl','r_dq_first_name_cl','r_dq_last_name_cl','r_dq_e_mail_cl','r_dq_primary_phone_cl','r_dq_alternate_phone_1_cl','r_dq_alternate_phone_2_cl','r_mailing_address_no_zipcode_dq_cl','r_service_address_no_zipcode_dq_cl','r_account_type','unique_id','source_dataset']
...
settings_rule23 = {
    ...
    "additional_columns_to_retain":['last_name_cl','rcis_id_cl','fa_id_cl','account_type']
}
