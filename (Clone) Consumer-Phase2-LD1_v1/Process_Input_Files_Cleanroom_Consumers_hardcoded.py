...
shaw_consumer_contact_filtered = shaw_consumer_contact_df.filter(col('SNAPSHOT_STAMP') == '2023-06-06')
shaw_consumer_wireline_account_filtered = shaw_consumer_wireline_account_df.filter(col('SNAPSHOT_STAMP') == '2023-06-06')
shaw_consumer_wireless_account_filtered = shaw_consumer_wireless_account_df.filter(col('SNAPSHOT_STAMP') == '2023-06-06')
shaw_consumer_wireless_service_filtered = shaw_consumer_wireless_service_df.filter(col('SNAPSHOT_STAMP') == '2023-06-06')
...
rogers_wireless_serviceability_filtered = rogers_wireless_serviceability_df
rogers_wireline_serviceability_filtered = rogers_wireline_serviceability_df
shaw_wireline_serviceability_filtered = shaw_wireline_serviceability_df.filter(col('SNAPSHOT_STAMP') == '2023-06-06')
rogers_service_qualification_filtered = rogers_service_qualification_df
rogers_service_qualification_item_filtered = rogers_service_qualification_item_df
