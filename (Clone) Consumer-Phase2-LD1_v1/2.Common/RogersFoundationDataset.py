...
# MAGIC <ul>
# MAGIC
# MAGIC   <li>The processed datasets are available in the Processed Layer</li>
# MAGIC
# MAGIC </ul>
# MAGIC
# MAGIC
...
rogers_wireline_account_df = rogers_wireline_account_df.withColumnRenamed('PostalCode_Cleansed', 'service_postalcode_cl')
rogers_contact_df          = rogers_contact_df.withColumnRenamed('PostalCode_Cleansed', 'mailing_postalcode_cl')
...
r_wls_c_final       = r_wls_c_joined_temp.withColumn('r_service_address_cl', lit(None).cast(StringType()))\
                                         ...
                                         .withColumn("r_service_postalcode_cl",lit(None).cast(StringType()))
...
r_wln_c_final = r_contact_filtered.alias('cf').join(r_wln_account_filtered.alias('wnf'),col("cf.r_fa_id_cl")==col("wnf.r_fa_id_cl"),how='inner')\
